...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// МайоровАВ 250401 Нетология Добавление поставляемых профилей Начало доработки ((
	// Проект доработки модуля ВКМ	
	
	// Папка профилей "Ваш компьютерный мастер".
	ОписаниеПапки = УправлениеДоступом.НовоеОписаниеПапкиПрофилейГруппДоступа();
	ОписаниеПапки.Имя           = "ВашКомпьютерныйМастер";
	ОписаниеПапки.Идентификатор = "0eb39726-f5b4-11ef-b6d5-94de8069cc79";
	ОписаниеПапки.Наименование  =
		НСтр("ru = 'Ваш компьютерный мастер'",
			ОбщегоНазначения.КодОсновногоЯзыка());
	ОписанияПрофилей.Добавить(ОписаниеПапки);
	...
	ОписаниеПрофиля.Родитель      = "ВашКомпьютерныйМастер";
	ОписаниеПрофиля.Идентификатор = "de1e2bb2-035c-11f0-b6f3-94de8069cc79";
	...
	ОписаниеПрофиля.Родитель      = "ВашКомпьютерныйМастер";
	ОписаниеПрофиля.Идентификатор = "de1e2bb1-035c-11f0-b6f3-94de8069cc79";
	ОписаниеПрофиля.Наименование  =
	...
	ОписаниеПрофиля.Родитель      = "ВашКомпьютерныйМастер";
	ОписаниеПрофиля.Идентификатор = "de1e2bb3-035c-11f0-b6f3-94de8069cc79";
	ОписаниеПрофиля.Наименование  =
	...
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Родитель      = "ВашКомпьютерныйМастер";
	ОписаниеПрофиля.Идентификатор = "de1e2bb0-035c-11f0-b6f3-94de8069cc79";
	ОписаниеПрофиля.Наименование  =
		НСтр("ru = 'Менеджер'",
			ОбщегоНазначения.КодОсновногоЯзыка());
	ОписаниеПрофиля.Описание =
	...
	// )) Конец доработки МайоровАВ 250401 Нетология Добавление поставляемых профилей
