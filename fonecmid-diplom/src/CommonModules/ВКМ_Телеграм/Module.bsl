...
//	HTTPЗапрос.УстановитьТелоИзСтроки(Ресурс);
//	
//	HTTPОтвет = HTTPСоединение.Получить(HTTPЗапрос);
//	КодСостояния = HTTPОтвет.КодСостояния;
//	
	//	Ответ = ВКМ_ОбщегоНазначенияHTTP.ОтветJSON(HTTPОтвет);
...
//	ИдентификаторЧата = Константы.ВКМ_ИдентификаторГруппыОповещения.Получить();
//	ТекстСообщения = "Тест Джейсон";
//	
//	SSL = Новый ЗащищенноеСоединениеOpenSSL();
//	HTTPСоединение = Новый HTTPСоединение(Host, , , , , ,SSL);
//	
//	ДанныеСообщения = Новый Структура;
//	ДанныеСообщения.Вставить("methot", "sendMessage");
