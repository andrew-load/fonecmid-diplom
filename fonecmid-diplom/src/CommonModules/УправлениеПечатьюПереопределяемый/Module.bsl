...
Процедура ПриОпределенииНастроекПечати(Настройки) Экспорт
	...
	// МайоровАВ Нетология 250227 добавление документа Акт предоставления услуг Начало доработки((
	// Проект внедрение ВКМ
	Настройки.ОбъектыПечати.Добавить(Документы.РеализацияТоваровУслуг);
	// конец доработки МайоровАВ Нетология 250227 добавление документа Акт предоставления услуг
