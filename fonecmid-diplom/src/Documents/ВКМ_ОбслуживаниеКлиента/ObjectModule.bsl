...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если Не ЭтоНеНовыйОбслуживаниеКлиента Тогда
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если Не ЭтоНовый() И Не ЭтоНеНовыйОбслуживаниеКлиента Тогда
		ЭтоНеНовыйОбслуживаниеКлиента = Истина;
		Записать();
	КонецЕсли;
	
	Если ЭтоНеНовыйОбслуживаниеКлиента Тогда
...
Процедура ЗаписатьУведомлениеТелеграмБоту()
	...
	ТекстовоеСообщение = СтрШаблон("Дата посещения: %1
		|Номер: %4
		|Время: %2
		|Сотрудник: %3", Формат(ДатаПроведенияРабот, "ДФ=dd.MM.yyyy;"), Формат(ВремяНачалаРабот,"ДЛФ=T"), Специалист, Номер);
