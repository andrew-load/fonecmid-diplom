Процедура ЗаполнитьГрафик(ДатаНачала, ДатаОкончания, ВыходныеДни, ГрафикРаботы) Экспорт 
	...
	//добавляем отбор по графику, чтобы перезаписывался только записи, связанные с определнным графиком.
	//если этого не сделать, то будет очищаться весь регистр целиком
